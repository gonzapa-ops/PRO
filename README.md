...
const REGIONES_COMUNAS = {
  ...
  "LIBERTADOR GENERAL BERNARDO O'HIGGINS": ["RANCAGUA", "ACOPIADOR", "CODEGUA", "COLFAX", "DOÑIHUE", "GRANEROS", "LAS CABRAS", "MACHALÍ", "MALLOA", "MOSTAZA", "OLIVAR", "PEUMO", "REQUÍNOA", "SAN FRANCISCO DE MOSTAZAL", "SAN VICENTE", "SANTA CRUZ", "PICHILEMU", "LA ESTRELLA", "LITUECHE", "MARCHIHUE", "NAVIDAD", "CURICÓ", "HUALAÑÉ", "LICANTÉN", "MOLINA", "RAUCO", "ROMERAL", "SAGRADA FAMILIA", "TALIUCA"],
