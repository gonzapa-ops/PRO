    ...
    <script>
        ...
        function buscarCliente() {
            ...
            if (cliente) {
                ...
                limpiarCamposFormulario(); modoEdicion = false;
            }
        }
        ...
        function listarArticulos() {
            ...
            let html = `<table class="tabla-articulos"><thead>
                <tr>
                <th>CÓDIGO</th><th>DESCRIPCIÓN</th><th>COSTO</th><th>PORCENTAJE (%)</th><th>VALOR NETO</th><th>PROVEEDOR</th><th>LINK</th><th>ACCIÓN</th>
                </tr></thead><tbody>`;
            const claves = Object.keys(todos);
            if(claves.length===0){
                html += `<tr><td colspan="8" style="text-align:center; color:#888;">NO HAY ARTÍCULOS</td></tr>`;
            }
